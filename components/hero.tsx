  ...
  return (
    <div className="relative h-screen w-full overflow-hidden bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-800">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center px-4 z-10">
        ...
        >
          <Image src={logoSrc} alt="Azordev logo" className="w-40 h-auto filter invert brightness-0" />
        ...
        <button className="px-8 py-3 rounded-full bg-gradient-to-r from-blue-500 to-purple-600 text-white font-semibold 
